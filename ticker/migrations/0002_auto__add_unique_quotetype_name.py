...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'QuoteType', fields ['name']
        db.create_unique(u'ticker_quotetype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuoteType', fields ['name']
        db.delete_unique(u'ticker_quotetype', ['name'])
