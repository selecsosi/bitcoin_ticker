...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.exchange_timestamp'
        db.add_column(u'ticker_quote', 'exchange_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quote.exchange_timestamp'
        db.delete_column(u'ticker_quote', 'exchange_timestamp')
